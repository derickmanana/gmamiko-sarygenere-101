...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GMAMIKO101 — IA pour transformer vos photos en publicités pro" },
      ...
      { property: "og:title", content: "GMAMIKO101 — IA pour vendeurs et créateurs" },
      { property: "og:description", content: "Transformez vos photos produit en publicités professionnelles avec l'IA." },
